...
export function Footer({ donate }: Props) {
	...
	return <footer>
		<p>
			<span>{locale('developed_by')} <a href="https://github.com/misode" target="_blank" rel="noreferrer">Misode</a> {locale('modified_by')} <a href="https://github.com/DrexHD" target="_blank" rel="noreferrer">DrexHD</a></span>
		</p>
